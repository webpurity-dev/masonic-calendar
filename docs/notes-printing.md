...
| Supplied PDF sheet | 4.843 x 6.535 in | 123 x 166 mm |
| Area outside crop marks on each edge | 0.354 in | 9 mm |

The supplied document is A6 portrait with a full-bleed cover. The black crop marks identify the finished 105 x 148 mm trim size; trim to these marks.

## Binding Margins
The PDF uses alternating margins for booklet binding. Measurements are from the finished trim edge.
...
## Trim And Crop Marks
The supplied PDF includes 9 mm outside the crop marks on every edge. Black crop marks appear at all four finished-trim corners.
...
- Confirm whether single pages or an imposed booklet PDF is required before printing.

## Preflight Checklist
- Confirm the supplied PDF measures 123 x 166 mm and the crop marks identify a 105 x 148 mm finished trim.
...
| Crop marks visible in the job | Crop marks are expected and must be removed during trimming. |